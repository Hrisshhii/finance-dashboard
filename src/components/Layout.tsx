...
export const Layout=({ children, active, setActive }: LayoutProps)=>{
  ...
  return (
    <div className="flex items-start min-h-screen bg-gray-50 dark:bg-gray-900">
      <div className={clsx("bg-white dark:bg-gray-800 dark:text-white shadow-md p-4 fixed md:sticky md:top-0 left-0 h-screen z-50 transition-all duration-300",
          collapsed ? "w-20" : "w-64",
